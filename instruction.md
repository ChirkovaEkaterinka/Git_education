...
* ***Как вставить рисунок?*** 
    ...
    ***
    ...
    Чтобы объединить ветки нужно набрать команду *git merge <название ветки>*. При этом если изменения нужно сохранить в ветке *master*, то для начала нужно перейти в ветку *master*
